...
import type { AlternateYamlLanguageServiceClientCapabilities } from "../client/AlternateYamlLanguageServiceClientCapabilities";
import type { ComposeLanguageClientCapabilities } from "../client/ClientCapabilities";
import {
	DocumentSettingsNotification,
	type DocumentSettingsNotificationParams,
} from "../client/DocumentSettings";
import { initEvent } from "../client/TelemetryEvent";
import { ComposeDocument } from "./ComposeDocument";
import type { ExtendedParams, TextDocumentParams } from "./ExtendedParams";
	...
	public constructor(
		...
		this.subscriptions.push(
			(this.telemetryAggregator = new TelemetryAggregator(
				this.connection,
				clientParams.initializationOptions
					?.telemetryAggregationInterval,
			)),
		);
	}
